...
import com.example.geojsontest.model.MultiPolygon
      ...
      when (reader.selectName(MultiPolygonJsonAdapter.KEYS_OPTIONS)) {
        0 -> {
          try {
            ...
            throw JsonDataException(("'type' is not of MultiPolygon at ${reader.path}"), exception)
          }
        }
        1 -> {
          reader.beginArray()
